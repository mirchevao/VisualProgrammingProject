...
По завршувањето на играта, односно откако играчот ќе ја загуби играта се прикажува излезното мени. Излезното мени се состои од место каде се прикажани вкупните поени кои се освоневи во текот на играта и две копчиња, од кои едното е за започнување на нова игра, а другото е за излез од апликацијата. Ова мени се прикажува само доколку непријателска топка дојде во интеракција со играчот, односно во спротивен случај играта би траела бесконечно. <br/>

<br/>
<img src="GameScreenshots/exitmenu.png" width="500">
(сл3. Приказ на излезениот прозорец)
<br/>
...
(сл4. Приказ на кодот за листите каде што се чуваат Покемоните)
<br/>
...
(сл5. Приказ на кодот за промена на Покемон и ниво)
<br/>
...
(сл6. Приказ на кодот за промена на селектирано ниво)
<br/>
...
(сл7. Приказ на дел од функцијата Form1_Load())
<br/>
...
(сл8. Приказ на кодот за имплементација на копче за излез од играта и започнување на нова игра)
<br/>
